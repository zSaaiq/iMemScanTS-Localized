...
- (UIImage*)icon
{
    if(nil == _icon)
    {
        _icon = [UIImage _applicationIconImageForBundleIdentifier:self.bundleIdentifier format:1 scale:2.0];
    }
...
//      NSLog(@"yiming: %@,%@", _applicationProxy.localizedName, _applicationProxy.bundleIdentifier);
//
